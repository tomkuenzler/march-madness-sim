<script>
  ...
  const ODDS_ROUND_TO_RESULT_KEY = {
    S16: '_R1_', E8: '_R2_', FF: '_R3_', Championship: '_R4_',
  };
  const ODDS_ROUND_TO_NEXT_GAME = {
    S16: 2, E8: 3, FF: 4, Championship: 5,
  };

  let matchupBets = $derived(() => {
